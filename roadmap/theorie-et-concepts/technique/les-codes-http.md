...
Lorsqu’un client (navigateur, application, API) envoie une requête à un serveur via HTTP, celui-ci répond toujours avec un **code de statut** à trois chiffres. Ces codes permettent de connaître rapidement le **résultat de la requête** : succès, erreur côté client, erreur côté serveur, etc.Chaque code appartient à une **famille** identifiée par son premier chiffre :
...
### Les grandes familles de codes HTTP <a href="#les-grandes-familles-de-codes-http" id="les-grandes-familles-de-codes-http"></a>

#### 1xx – Informations <a href="#id-1xx-informations" id="id-1xx-informations"></a>
...
#### 2xx – Succès <a href="#id-2xx-succes" id="id-2xx-succes"></a>
...
#### 3xx – Redirection <a href="#id-3xx-redirection" id="id-3xx-redirection"></a>
...
#### 4xx – Erreurs côté client <a href="#id-4xx-erreurs-cote-client" id="id-4xx-erreurs-cote-client"></a>
...
#### 5xx – Erreurs côté serveur <a href="#id-5xx-erreurs-cote-serveur" id="id-5xx-erreurs-cote-serveur"></a>
...
### Tableau récapitulatif des code HTTP courants <a href="#tableau-recapitulatif-des-code-http-courants" id="tableau-recapitulatif-des-code-http-courants"></a>
