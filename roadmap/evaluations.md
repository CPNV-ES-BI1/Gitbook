...
* après 15 minutes d'épreuve, une brève session de question-réponse pour lever des doutes sur la formulation de certaines questions,
...
Il s'agira de présenter **3 livrables (fin de sprint**) durant lequel aussi bien la review (Sprint Review) et la rétropsective (Sprint restrospective) seront évalués.
...
* en équipe de 2 (ou 3) devteam,
* 1 période par dev team,
* le code que vous présenterez en review devra avoir été livré 12 heures avant la review.
